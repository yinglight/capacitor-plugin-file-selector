package com.valley.file.selector.media.preview.view;
...
import com.valley.file.selector.media.preview.GPreviewActivity;
import com.valley.file.selector.media.preview.ZoomMediaLoader;
import com.valley.file.selector.media.preview.enitity.IThumbViewInfo;
import com.valley.file.selector.media.preview.loader.MySimpleTarget;
import com.valley.file.selector.media.preview.loader.VideoClickListener;
import com.valley.file.selector.media.preview.wight.SmoothImageView;
import com.valley.file.selector.media.preview2.PhotoViewAttacher;

/**
 * author yangc date 2017/4/26 E-Mail:yangchaojiang@outlook.com Deprecated:
 * 图片预览单个图片的fragment
 */
public class BasePhotoFragment extends Fragment {
    ...
    public static BasePhotoFragment getInstance(Class<? extends BasePhotoFragment> fragmentClass, IThumbViewInfo item,
                                                boolean currentIndex, boolean isSingleFling, boolean isDrag, float sensitivity) {
    ...
    private void initView(View view) {
         ...
         * 
         * @Override public void onClick(View v) { String video =
         * beanViewInfo.getVideoUrl(); if (video != null && !video.isEmpty()) { if
         * (listener != null) { listener.onPlayerVideo(video); } else {
        ...
        mySimpleTarget = new MySimpleTarget() {
            ...
            public void onResourceReady() {
                 ...
                 * ViewCompat.animate(btnVideo).alpha(1).setDuration(1000).start(); } else {
    ...
    private void initData() {
        ...
        if (bundle != null) {
            ...
            if (beanViewInfo.getUrl().toLowerCase().contains(".gif")) {
                ...
                // 加载图
                ZoomMediaLoader.getInstance().getLoader().displayGifImage(this, beanViewInfo.getUrl(), imageView,
                        mySimpleTarget);
            } else {
                // 加载图
                ZoomMediaLoader.getInstance().getLoader().displayImage(this, beanViewInfo.getUrl(), imageView,
                        mySimpleTarget);
            }
         ...
         * {
         * 
         * @Override public void onAlphaChange(int alpha) { if (alpha == 255) { String
         * video = beanViewInfo.getVideoUrl(); if (video != null && !video.isEmpty()) {
         * btnVideo.setVisibility(View.VISIBLE); } else {
         * btnVideo.setVisibility(View.GONE); } } else {
         * btnVideo.setVisibility(View.GONE); }
